...
<head>
	...
	<!-- Main css -->
	<link rel="stylesheet" href="/project/css/fontawesome-all.css">
	<!-- Font-Awesome-Icons-CSS -->
	<link href="/project/css/popuo-box.css" rel="stylesheet" type="text/css" media="all" />
	<!-- pop-up-box -->
	<link href="/project/css/menu.css" rel="stylesheet" type="text/css" media="all" />
	<!-- menu style -->
	<!-- //Custom-Files -->
				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.html" class="font-weight-bold font-italic">
							<img src="/project/images/logo2.png" alt=" " class="img-fluid">Electro Store
						</a>
					</h1>
				</div>
				<!-- //logo -->
...
<div class="grid-form">
 		...
 		<h2 id="forms-example" class="">Register</h2>
		<?php
	require("connection.php");
	$edit=$_REQUEST["view"];
	$res=$con->query("select*from tb_user where id=$edit");
	$count=$res->num_rows;
	if($count>0)
	{
		$row=$res->fetch_assoc();
	...
	?>
 		<form action="userupdate.php" enctype="multipart/form-data" method="post">
		<div class="form-group">
		    <label for="id"></label>
    ...
    <input type="text"  value="<?php echo $row["user_name"];?>" class="form-control" id="exampleInputName1" placeholder="Name" name="name">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Email</label>
    <input type="email"  value="<?php echo $row["email"];?>" class="form-control" id="exampleInputEmail1" placeholder="Email" name="mail">
  </div>
  <div class="form-group">
    <label for="exampleInputPhone1">mobile number</label>
    <input type="text"  value="<?php echo $row["mbl.no"];?>" class="form-control" id="exampleInputphone1" placeholder="Phone number" name="number">
  </div>
  <div class="form-group">                    
  <label for="exampleInputFile1">select countries</label>
  ...
  ?>
  <option   selected><?php echo $row1["name"];?></option>
  <?php
  require("connection.php");
  ...
  <label for="exampleInputFile1">state</label>
  ...
  ?>
  <option selected><?php echo $row2["sname"];?></option>
  </select>
  </div>
  <div class="form-group">
  <button type="submit" class="btn btn-default">Submit</button>
	...
	<script src="/project/js/jquery-2.2.3.min.js"></script>
	<!-- //jquery -->
	...
	<script src="/project/js/jquery.magnific-popup.js"></script>
	<script>
		$(document).ready(function () {
	...
	<script src="/project/js/jquery-3.7.1.min.js"></script>
	<script>
		$(document).ready(function() {
...
var country=$('#country').val();
	...
	<!-- cart-js -->
	<script src="/project/js/minicart.js"></script>
	<script>
	...
	<!-- smoothscroll -->
	<script src="/project/js/SmoothScroll.min.js"></script>
	<!-- //smoothscroll -->

	<!-- start-smooth-scrolling -->
	<script src="/project/js/move-top.js"></script>
	<script src="/project/js/easing.js"></script>
	<script>
